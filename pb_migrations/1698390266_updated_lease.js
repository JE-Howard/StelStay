...
migrate((db) => {
  ...
  collection.listRule = "@request.auth.type = \"Resident\" && (student_id.email = @request.auth.email || bill_payer_id.students_email.email = @request.auth.email) && @collection.lease_Application.approved = true || @request.auth.type = \"Admin\" "
